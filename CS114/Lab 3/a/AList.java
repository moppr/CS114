...
class AList<E> implements List<E> {
  protected static final int defaultSize = 10; // Default size
  protected int maxSize;        // Maximum size of list
  protected int listSize;       // Current # of list items
  protected int curr;           // Position of current element
